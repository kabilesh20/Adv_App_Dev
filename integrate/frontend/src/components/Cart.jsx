  ...
  return (
    <div className="ShoppingCart">
      ...
      <Modal show={showModal} onHide={closeModal} centered>
        ...
        <Modal.Body>You already choose this course</Modal.Body>
        <Modal.Footer>
          <button
      ...
      <Modal show={showModal} onHide={closeModal} centered>
        <Modal.Header closeButton>
          <Modal.Title>Thank you for choosing our Course</Modal.Title>
        </Modal.Header>
        <Modal.Body>You will get an email regarding the Course </Modal.Body>
        <Modal.Footer>
          <button
            className="model-btn"
            onClick={closeModal}
